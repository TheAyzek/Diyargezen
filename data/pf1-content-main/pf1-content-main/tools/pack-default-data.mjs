 ...
 *
 * @returns {object} - Default change data
 */
...
/**
 * @returns {object} - Token default data
 */
...
/**
 * Return the default data for an `Item` document. *
 *
 * @param {string} type   The type of item to add missing data to
 * @param {*} data       The data to add missing data to
 * @returns {object}     The data with missing data added
 */
export function addMissingItemData(type, data = {}) {
  data.showInCombat = false;

  switch (type) {
    case "race":
    case "container":
    case "class":
      delete data.showInCombat;
      break;
  }
